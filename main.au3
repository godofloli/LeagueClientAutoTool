...
#AutoIt3Wrapper_Res_Description=Everything automated
...
$bp_tab = GUICtrlCreateTabItem("BlindPick Tools")
...
$Label1 = GUICtrlCreateLabel("Primary Lane", 56, 88, 108, 20, $SS_CENTER)
GUICtrlSetFont(-1, 12, 400, 0, "Vermin Vibes")
$Label2 = GUICtrlCreateLabel("Secondary Lane", 216, 88, 124, 20, $SS_CENTER)
GUICtrlSetFont(-1, 12, 400, 0, "Vermin Vibes")
$champ_ban_dp = GUICtrlCreateList("", 48, 208, 145, 240)
GUICtrlSetData($champ_ban_dp, "Aatrox|Ahri|Akali|Alistar|Amumu|Anivia|Annie|Ashe|Aurelion Sol|Azir|Bard|Blitzcrank|Brand|Braum|Caitlyn|Camille|Cassiopeia|Cho'Gath|Corki|Darius|Diana|Dr Mundo|Draven|Ekko|Elise|Evelynn|Ezreal|Fiddlesticks|Fiora|Fizz|Galio|Gangplank|Garen|Gnar|Gragas|Graves|Hecarim|Heimerdinger|Illaoi|Irelia|Ivern|Janna|Jarvan|Jax|Jayce|Jhin|Jinx|Kalista|Karma|Karthus|Kassadin|Katarina|Kayle|Kayn|Kennen|Kha'Zix|Kindred|Kled|Kog'Maw|Leblanc|Lee Sin|Leona|Lissandra|Lucian|Lulu|Lux|Malphite|Malzahar|Maokai|Master Yi|Miss Fortune|Mordekaiser|Morgana|Nami|Nasus|Nautilus|Nidalee|Nocturne|Nunu & Willump|Olaf|Orianna|Pantheon|Poppy|Pyke|Quinn|Rakan|Rammus|Rek'sai|Renekton|Rengar|Riven|Rumble|Ryze|Sejuani|Shaco|Shen|Shyvana|Singed|Sion|Sivir|Skarner|Sona|Soraka|Swain|Syndra|Tahm Kench|Taliyah|Talon|Taric|Teemo|Thresh|Tristana|Trundle|Tryndamere|Twisted Fate|Twitch|Udyr|Urgot|Varus|Vayne|Veigar|Vel'Koz|Vi|Viktor|Vladimir|Volibear|Warwick|Wukong|Xayah|Xerath|Xin Zhao|Yasuo|Yorick|Zac|Zed|Ziggs|Zilean|Zoe|Zyra", "Garen")
$champ_pick_dp = GUICtrlCreateList("", 208, 208, 145, 240)
GUICtrlSetData($champ_pick_dp, "Aatrox|Ahri|Akali|Alistar|Amumu|Anivia|Annie|Ashe|Aurelion Sol|Azir|Bard|Blitzcrank|Brand|Braum|Caitlyn|Camille|Cassiopeia|Cho'Gath|Corki|Darius|Diana|Dr Mundo|Draven|Ekko|Elise|Evelynn|Ezreal|Fiddlesticks|Fiora|Fizz|Galio|Gangplank|Garen|Gnar|Gragas|Graves|Hecarim|Heimerdinger|Illaoi|Irelia|Ivern|Janna|Jarvan|Jax|Jayce|Jhin|Jinx|Kalista|Karma|Karthus|Kassadin|Katarina|Kayle|Kayn|Kennen|Kha'Zix|Kindred|Kled|Kog'Maw|Leblanc|Lee Sin|Leona|Lissandra|Lucian|Lulu|Lux|Malphite|Malzahar|Maokai|Master Yi|Miss Fortune|Mordekaiser|Morgana|Nami|Nasus|Nautilus|Nidalee|Nocturne|Nunu & Willump|Olaf|Orianna|Pantheon|Poppy|Pyke|Quinn|Rakan|Rammus|Rek'sai|Renekton|Rengar|Riven|Rumble|Ryze|Sejuani|Shaco|Shen|Shyvana|Singed|Sion|Sivir|Skarner|Sona|Soraka|Swain|Syndra|Tahm Kench|Taliyah|Talon|Taric|Teemo|Thresh|Tristana|Trundle|Tryndamere|Twisted Fate|Twitch|Udyr|Urgot|Varus|Vayne|Veigar|Vel'Koz|Vi|Viktor|Vladimir|Volibear|Warwick|Wukong|Xayah|Xerath|Xin Zhao|Yasuo|Yorick|Zac|Zed|Ziggs|Zilean|Zoe|Zyra", "Rengar")

$tit1 = GUICtrlCreateLabel("Champion to ban", 56, 176, 123, 20, $SS_CENTER)
GUICtrlSetFont(-1, 12, 400, 0, "Vermin Vibes")
$tit2 = GUICtrlCreateLabel("Champion to pick", 216, 176, 126, 20, $SS_CENTER)
GUICtrlSetFont(-1, 12, 400, 0, "Vermin Vibes")
$launch_dp = GUICtrlCreateButton("Launch That Shit", 131, 488, 147, 25)
$op_tab = GUICtrlCreateTabItem("OP Tools")
GUICtrlSetBkColor($op_tab, $COLOR_BLACK)
$auto_accept = GUICtrlCreateCheckbox("Enable AutoAccept", 50, 70, 209, 33)
GUICtrlSetFont(-1, 16, 400, 0, "Segoe UI Symbol")
$auto_report = GUICtrlCreateCheckbox("Enable AutoReport Enemies", 50, 113, 300, 33)
GUICtrlSetFont(-1, 16, 400, 0, "Segoe UI Symbol")
$pingtest = GUICtrlCreateButton("Launch Ping Checker", 95, 208, 219, 57)
GUICtrlSetFont(-1, 16, 400, 0, "Segoe UI Symbol")

$auto_login = GUICtrlCreateTabItem("Auto Login")
GUICtrlSetState(-1, $GUI_SHOW)
$username_input = GUICtrlCreateInput("", 90, 104, 241, 33, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
GUICtrlSetFont(-1, 18, 400, 0, "Vermin Vibes")
$Label7 = GUICtrlCreateLabel("USERNAME", 142, 64, 124, 31, $SS_CENTER)
GUICtrlSetFont(-1, 20, 400, 0, "Vermin Vibes")
$Label8 = GUICtrlCreateLabel("PASSWORD", 142, 168, 124, 31, $SS_CENTER)
GUICtrlSetFont(-1, 20, 400, 0, "Vermin Vibes")
$pass_input = GUICtrlCreateInput("", 90, 208, 241, 38, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
GUICtrlSetFont(-1, 18, 800, 0, "Nexa Bold")
$launchlogin = GUICtrlCreateButton("LOGIN", 135, 280, 139, 33)
GUICtrlSetFont(-1, 18, 400, 0, "Vermin Vibes")
...
Func Login()
	...
	$rememberme = "all image\rememberme.PNG"
